(function initAITeacherStorage(global) {
  ...
  const SQLITE_SCHEMA = [
    ...
    "CREATE TABLE IF NOT EXISTS classes (id TEXT PRIMARY KEY, name TEXT NOT NULL, grade_id TEXT NOT NULL, subject_id TEXT NOT NULL, volume_id TEXT NOT NULL, status TEXT NOT NULL, payload_json TEXT NOT NULL, created_at TEXT NOT NULL, updated_at TEXT NOT NULL);",
    "CREATE TABLE IF NOT EXISTS students (id TEXT PRIMARY KEY, class_id TEXT NOT NULL, name TEXT NOT NULL, student_no TEXT, status TEXT NOT NULL, payload_json TEXT NOT NULL, created_at TEXT NOT NULL, updated_at TEXT NOT NULL);",
    ...
    "CREATE TABLE IF NOT EXISTS coursewares (id TEXT PRIMARY KEY, class_id TEXT, scope_key TEXT NOT NULL, title TEXT NOT NULL, review_status TEXT NOT NULL, export_version TEXT NOT NULL, payload_json TEXT NOT NULL, created_at TEXT NOT NULL, updated_at TEXT NOT NULL);",
    ...
    "CREATE TABLE IF NOT EXISTS papers (id TEXT PRIMARY KEY, class_id TEXT, creator_account_id TEXT, paper_type TEXT NOT NULL, scope_key TEXT NOT NULL, title TEXT NOT NULL, total_score INTEGER NOT NULL, review_status TEXT NOT NULL, export_version TEXT NOT NULL, payload_json TEXT NOT NULL, created_at TEXT NOT NULL, updated_at TEXT NOT NULL);",
    ...
    "CREATE TABLE IF NOT EXISTS submissions (id TEXT PRIMARY KEY, paper_id TEXT, class_id TEXT, student_id TEXT, origin TEXT NOT NULL, score INTEGER NOT NULL, total_score INTEGER NOT NULL, accuracy INTEGER NOT NULL, payload_json TEXT NOT NULL, created_at TEXT NOT NULL);",
    "CREATE TABLE IF NOT EXISTS submission_answers (id TEXT PRIMARY KEY, submission_id TEXT NOT NULL, question_id TEXT, order_no INTEGER NOT NULL, student_answer TEXT, correct_answer TEXT NOT NULL, is_correct INTEGER NOT NULL, score INTEGER NOT NULL, point INTEGER NOT NULL, payload_json TEXT NOT NULL);",
    ...
    "CREATE TABLE IF NOT EXISTS generation_records (id TEXT PRIMARY KEY, class_id TEXT, kind TEXT NOT NULL, scope_key TEXT NOT NULL, source TEXT, item_count INTEGER NOT NULL, payload_json TEXT NOT NULL, created_at TEXT NOT NULL);",
    ...
    function sqliteMigrationPlan() {
      return {
        ...
        strategy: [
          ...
          "后端上线时由 Go 或 Java 服务接管账号、班级、学生、课件、试卷、提交和 OCR 记录"
        ]
      };
    }
